...
import iot.tools.utils.GeoHash;
...
public class BaseStreamer extends Thread{
	...
	protected void enterCount() {
		DataStream<String> points = env.socketTextStream(host, port, "\n");
		// parse the data, group it, window it, and aggregate the counts
		SingleOutputStreamOperator<Tuple2<String,Long>> processed = points.flatMap(new SimpleMapper())
	...
	public static class SimpleMapper implements FlatMapFunction<String, Tuple2<String,Long>> {
		...
		GeoHash hasher = new GeoHash();
		@Override
		public void flatMap(String value, Collector<Tuple2<String,Long>> out) {
			JSONObject obj = new JSONObject(value);
			String geohash = hasher.encode(obj.getDouble("latitude"), obj.getDouble("longitude"));
			out.collect(new Tuple2<String,Long>(geohash,1L));
		}
	}
