...
public class AOTStreamer extends BaseStreamer {
    ...
    public void run(){
		...
		processed.print();
		// processed.writeAsText("/Users/furqan/Workspace/iotdb/IoTDB/streamer/processed_out.txt");
			
		//text.map(new ThingMapper()).writeAsText("/Users/furqan/Workspace/iotdb/IoTDB/streamer/out.txt");
